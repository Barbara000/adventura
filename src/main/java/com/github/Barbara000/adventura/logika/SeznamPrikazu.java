package com.github.Barbara000.adventura.logika;
...
public class SeznamPrikazu {
     ...
     *
     *@param  retezec  �?etězec, který se má otestovat, zda je přípustný příkaz
     ...
     *  
     *  @return     �?etězec, který obsahuje seznam přípustných příkazů
     */
